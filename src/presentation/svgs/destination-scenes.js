export function SingaporeScene() {
  return `
...
export function getDestinationScene(id) {
  switch (id.toLowerCase()) {
    case 'singapore': return SingaporeScene();
    case 'bali': return BaliScene();
    case 'thailand': return ThailandScene();
    case 'vietnam': return VietnamScene();
    case 'dubai': return DubaiScene();
    default: return SingaporeScene();
  }
}
